...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "update tblproduct set image=:pimage where id=:imgid";
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="hotel" method="post" enctype="multipart/form-data">
                                    <?php
                                    $imgid = intval($_GET['imgid']);
                                    $sql = "SELECT `image` from tblproduct where id=:imgid";
                                    $query = $dbh->prepare($sql);
                                    $query->bindParam(':imgid', $imgid, PDO::PARAM_STR);
                                    $query->execute();
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {    ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <img src="images/shop/product/<?php echo htmlentities($result->image); ?>" width="200">
                                                </div>
                                            </div>
