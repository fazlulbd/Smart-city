...
move_uploaded_file($_FILES["emergencyimage"]["tmp_name"],"emergencyimages/".$_FILES["emergencyimage"]["name"]);$pemergencymap=$_FILES["emergencymap"]["name"];
move_uploaded_file($_FILES["emergencymap"]["tmp_name"],"emergencyimages/".$_FILES["emergencymap"]["name"]);	


$sql="INSERT INTO Tblemergencylist(ServiceFrom,LocationTo,NameService,Details,EmergencyImage,EmergencyMap) VALUES(:pservicefrom,:plocationto,:pnameservice,:pdetails,:pemergencyimage,:pemergencymap)";
...
$query->bindParam(':pemergencyimage',$pemergencyimage,PDO::PARAM_STR);
$query->bindParam(':pemergencymap',$pemergencymap,PDO::PARAM_STR);
$query->execute();
$lastInsertId = $dbh->lastInsertId();
if($lastInsertId)
{
$msg="Emergency Service Added Successfully";
}
else 
{
...
<html>
<head>
<title>Smart City || Admin Emergency Service Inserting </title>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="nameservice" id="nameservice" placeholder=" Service Name..." required></input>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Details</label>
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="details" id="details" placeholder="Service Details..." required></textarea> 
									</div>
								</div>															
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" name="emergencyimage" id="emergencyimage" required></input>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" name="emergencymap" id="emergencymap" required></input>
									</div>
								</div>
								<div class="row">
