		...
		<div class="room-bottom">
			...
			<div class="rom-btm-MyBookingHistory">
				...
				<div class="col-md-6 room-midle-MyBookingHistory wow fadeInUp animated" data-wow-delay=".5s">
					...
					<h4>See Your College Apply History </h4>
					<h4>See Your electicity bill History</h4>
				</div>
				<div class="col-md-3 room-right-MyBookingHistory wow fadeInRight animated" data-wow-delay=".5s">
					...
					<a href="school-history.php" class="view Your School Apply History">Details</a>
					<a href="college-history.php" class="viewMyBookingHistory">Details</a>
					<a href="electicity-history.php" class="viewMyBookingHistory">Details</a>
				</div>
